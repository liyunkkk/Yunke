...
internal object ConversationTitleModel {
    ...
    fun generate(config: AgentModelClient.ModelConfig, question: String, controller: AgentRunController): String {
        ...
        return normalize(ModelFeatureCompletion.complete(config, messages, controller,
            "title-${java.util.UUID.randomUUID()}", timeoutMs = 30_000, outputLimit = 512))
    }
