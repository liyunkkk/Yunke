    ...
    fun evaluate(
        ...
        return when {
            ...
            containsAny(haystack, MINIS_ANDROID_CLI) ->
                SkillCompatibilityResult(available = false, reason = "依赖 MiniS 专属 Android CLI，芸珂 无法运行")
            containsAny(haystack, MINIS_IOS_RUNTIME) ->
                SkillCompatibilityResult(available = false, reason = "依赖 MiniS / iSH 的 iOS 沙箱，芸珂 无法运行")
