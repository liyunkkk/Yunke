...
internal object SpeechInputSession {
    ...
    suspend fun recognize(context: Context, onListening: suspend () -> Unit, onText: suspend (String) -> Unit, mode: VoiceEntryMode = VoiceEntryMode.DICTATION, onLevel: (Float) -> Unit = {}, finishRequested: () -> Boolean = { false }): Boolean {
        ...
        try {
            ...
            return coroutineScope {
                ...
                try {
                    if (selected) DoubaoAsrSession.recognize(onListening, onText, onLevel, finishRequested)
                    else OfflineSpeechSession.recognize(context, onListening, onText, mode, onLevel, finishRequested)
